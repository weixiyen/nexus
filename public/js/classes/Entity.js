(function() {
  ...
  this.MovableEntity = (function() {
    ...
    MovableEntity.prototype.standFacing = function(direction) {
      return game.addLoopItem('unit:' + this.id + ':stop', this.speed * 10, __bind(function() {
        this.sprite.set(this.anim[direction][0]);
        return game.removeLoopItem('unit:' + this.id + ':stop');
      }, this));
    };
